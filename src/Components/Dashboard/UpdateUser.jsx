...
const UpdateUser = ({ openEditModal, UpdatemodalHideShow, user, Companyid }) => {
    ...
    const [selectedFacebookIcon, setSelectedFacebookIcon] = useState(user?.facebook_icon); // Initialize selectedIcon state
    const [selectedInstagramIcon, setSelectedInstagramIcon] = useState(user?.instagram_icon); // Initialize selectedIcon state
    const [selectedLinkedInIcon, setSelectedLinkedInIcon] = useState(user?.linkedin_icon); // Initialize selectedIcon state
    const [selectedWebsiteIcon, setSelectedWebsiteIcon] = useState(user?.website_icon); // Initialize selectedIcon state
    ...
    const onFinish = (values) => {
        ...
        formData.append('facebook_icon', selectedFacebookIcon || user.facebook_icon); 
        formData.append('instagram_icon',selectedInstagramIcon || user.instagram_icon);
        formData.append('linkedin_icon',selectedLinkedInIcon || user.linkedin_icon);
        formData.append('website_icon',selectedWebsiteIcon || user.website_icon);
        formData.append('save_button_value', saveButtonColor || user.save_button_value);
        formData.append('exchange_button_value', exchangeButtonColor || user.exchange_button_value);
        formData.append('background_button_value', backgroundColor || user.exchange_button_value);
