...
const Social = (props) => {
  ...
  const renderSocialIcon = (iconData, profileUrl, iconClass) => {
    ...
    const formattedIconUrl = isBase64
      ? iconData
      : iconData && !/^https?:\/\//i.test(iconData)
      ? `https://${iconData}`
      : iconData;
  ...
  const socialIconsData = [
    {
      iconData: userData?.facebook_icon,
      profileUrl: userData?.facebook_url,
      iconClass: "fa-facebook",
    },
    {
      iconData: userData?.instagram_icon,
      profileUrl: userData?.instagram_url,
      iconClass: "fa-instagram",
    },
    {
      iconData: userData?.linkedin_icon,
      profileUrl: userData?.linkedin_url,
      iconClass: "fa-linkedin",
    },
    {
      iconData: userData?.website_icon,
      profileUrl: userData?.other_link_1,
      iconClass: "fa-globe",
    },
  ];
